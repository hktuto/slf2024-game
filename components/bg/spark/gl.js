...
export const ParticleEngine = (function() {
	...
	function ParticleEngine(canvas_id) {
		...
		this.particleSettings = [{id:"small", num:300, fromX:0, toX:this.totalWidth, ballwidth:20, alphamax:0.4, areaHeight:.5, color:"#F0F0F0", fill:true}, 
								{id:"medium", num:100, fromX:0, toX:this.totalWidth,  ballwidth:30, alphamax:0.3, areaHeight:2, color:"#D7FDF1", fill:true}, 
								{id:"large", num:50, fromX:0, toX:this.totalWidth, ballwidth:50,  alphamax:0.5, areaHeight:2, color:"#FDFEE5", fill:true}];
		this.particleArray = [];
		...
		function drawBgLight()
		{
			...
			for (var i = 0, len = _ParticleEngine.lights.length; i < len; i++) {				
				...
				light.y = light.initY = _ParticleEngine.totalHeight - 50 + _ParticleEngine.lights[i].offsetY;
